####################################
# Save interval tiers to wav files #
####################################

# 1. Open > Open long sound file > myList.wav
# 2. Select LongSound object and corresponding TextGrid
# 3. commant + r
#
# Once you have finised (and it worked) go 
